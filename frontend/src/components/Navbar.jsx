/**
 * Navbar.jsx - Responsive navigation bar with active link highlighting.
 */
...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
        ...
        <NavLink to="/" className="flex items-center gap-2">
          <span
            ...
            style={{ fontFamily: "'DM Serif Display', serif", color: "#00ff9d" }}
          >
            SentiScope
          </span>
          <span
      ...
      {menuOpen && (
        <div
          className="md:hidden glass border-t px-4 pb-4 flex flex-col gap-3"
          style={{ borderColor: "rgba(255,255,255,0.07)" }}
        >
          {links.map(({ to, label }) => (
            <NavLink
