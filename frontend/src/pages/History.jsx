    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
        <div>
          ...
          <h1 className="font-display text-3xl sm:text-4xl font-bold text-white">Past Analyses</h1>
        </div>
        <button onClick={fetchHistory} className="btn-ghost text-sm self-start sm:self-auto">↻ Refresh</button>
      </div>
