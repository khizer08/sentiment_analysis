...
function getStats() {
  ...
  historyStore.forEach((e) => {
    if (e.sentiment === "Positive") breakdown.positive++;
    else if (e.sentiment === "Negative") breakdown.negative++;
    else breakdown.neutral++;
  });
  return { total: historyStore.length, breakdown };
}

module.exports = { processAnalysis, getHistory, clearHistory, getStats };
